...
class Config:
    def __init__(self, config_path):
        ...
        self.startup_notification = self.config.get('config', 'startup_notification', fallback='1') == '1'
    ...
    def update(self, data):
        ...
        self.config.set('config', 'startup_notification', str(int(data['startup_notification'])))
        ...
        self.startup_notification = data['startup_notification']
